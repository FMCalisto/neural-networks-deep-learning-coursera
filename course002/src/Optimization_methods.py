...
def initialize_velocity(parameters):
    ...
    for l in range(1, L + 1):
        ...
        # v["db" + str(l)] =
        # YOUR CODE STARTS HERE
        #(numpy array of zeros with the same shape as parameters["W" + str(l)])
        v["dW" + str(l)] = np.zeros(parameters["W" + str(l)].shape)
        #(numpy array of zeros with the same shape as parameters["b" + str(l)])
...
def update_lr(learning_rate0, epoch_num, decay_rate):
    ...
    # learning_rate = 
    # YOUR CODE STARTS HERE
    learning_rate = learning_rate0 / (1 + decay_rate * np.floor(epoch_num))
